    ...
    <>
      ...
      <div className="hc-bg">
        <div className="hc-bg-icons">
          ...
          <svg width="50" height="50" style={{ bottom: "20%", right: "5%" }} viewBox="0 0 80 80"><rect x="30" y="5" width="20" height="70" rx="4" fill="#4CAF50"/><rect x="5" y="30" width="70" height="20" rx="4" fill="#4CAF50"/></svg>

          
          <svg width="120" height="120" style={{ top: "40%", left: "1%" }} viewBox="0 0 100 100" fill="none">
            <path d="M25 10 Q25 40 50 50 Q75 60 75 80 Q75 95 60 95 Q45 95 45 80" stroke="#2196F3" strokeWidth="5" strokeLinecap="round" fill="none"/>
            <circle cx="25" cy="10" r="6" fill="#2196F3"/>
            <circle cx="35" cy="10" r="6" fill="#2196F3"/>
            <circle cx="60" cy="95" r="10" stroke="#2196F3" strokeWidth="4" fill="none"/>
          </svg>
          ...
          <svg width="200" height="60" style={{ bottom: "5%", right: "15%" }} viewBox="0 0 200 60" fill="none">
            <path d="M0 30 L40 30 L55 10 L65 50 L75 20 L85 40 L95 30 L200 30" stroke="#e53935" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          ...
          <svg width="45" height="45" style={{ top: "30%", right: "12%" }} viewBox="0 0 100 100">
            <path d="M50 85 L15 50 Q5 35 20 25 Q35 15 50 35 Q65 15 80 25 Q95 35 85 50 Z" fill="#e53935"/>
          </svg>

          
          <svg width="80" height="40" style={{ bottom: "35%", left: "6%" }} viewBox="0 0 80 40" fill="none">
            <rect x="2" y="2" width="76" height="36" rx="18" fill="#9c27b0"/>
            <rect x="2" y="2" width="38" height="36" rx="18" fill="#7b1fa2"/>
          </svg>
          <svg width="60" height="30" style={{ top: "75%", right: "10%" }} viewBox="0 0 80 40" fill="none">
            <rect x="2" y="2" width="76" height="36" rx="18" fill="#9c27b0"/>
            <rect x="2" y="2" width="38" height="36" rx="18" fill="#7b1fa2"/>
          </svg>

          
          <svg width="150" height="50" style={{ bottom: "15%", left: "10%" }} viewBox="0 0 200 60" fill="none">
            <path d="M0 30 L40 30 L55 10 L65 50 L75 20 L85 40 L95 30 L200 30" stroke="#e53935" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
        ...
        >
          <div className="card p-4 shadow" style={{ width: "100%", maxWidth: "360px" }}>
            ...
            <div className="d-flex gap-2">
              <button className="btn btn-primary w-50" onClick={handleConfirmYes}>
                Yes, Register
              </button>
              <button className="btn btn-outline-secondary w-50" onClick={handleConfirmNo}>
                Cancel
              </button>
            </div>
          </div>
